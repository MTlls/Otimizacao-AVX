...
set xtics
set xrange ["0":]
set xlabel  "Tamanho do vetor ou matriz"
...
com_otimizacao = sprintf("./%s/plot-%s-%s-MatMat.dat", "dados_grafico", "Otimizado", metrica)
sem_otimizacao = sprintf("./%s/plot-%s-MatMat.dat", "dados_grafico", metrica)
...
if(metrica ne "FLOPS_DP"){
     ...
     # Plot dos dados
     set terminal qt 1 title "Métrica <" . metrica . ">[matriz * matriz]"
